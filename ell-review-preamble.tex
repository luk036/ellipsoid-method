% -*- coding: utf-8 -*-
% Preamble for ell-review-slides.md, included via `--include-in-header` on the
% command line (see ell-review-beamer.yaml).  It lives in a file because pandoc
% parses `header-includes` values as Markdown, which mangles raw LaTeX such as
